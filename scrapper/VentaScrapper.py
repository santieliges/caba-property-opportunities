...
class VentaScrapper(Scrapper):
    def __init__(self, headless=True, url_base=None):
        self.url_base = url_base or "https://www.argenprop.com/casas-o-departamentos-o-ph/venta/capital-federal?orden-masnuevos"
        self.api_calls = []
    ...
    def extract_listings_from_page(self, page):
        ...
        for item in items:
            try:
                ...
                texto_tipo_inmueble = self.safe_text(item, ".card__title--primary")
                tipo_inmueble = self.extract_property_type(texto_tipo_inmueble)
    ...
    def extract_property_type(self, title: str) -> str | None:
        pattern = r"^(departamento|casa|ph|local|oficina|terreno)\b"
