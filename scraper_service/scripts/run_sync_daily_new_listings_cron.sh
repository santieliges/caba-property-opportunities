...
JOB_NAME=sync_daily_new_listings
...
DEFAULT_ARGENPROP_URL=${DEFAULT_ARGENPROP_URL:-https://www.argenprop.com/departamentos/venta/capital-federal?orden-masnuevos}
